...
class adminController extends AbstractController
{
    ...
    /**
     * @RouteScope(scopes={"api"})
     * @Route("/api/slox_product_sync/bdropy/categoriessubcategories", name="api.slox_product_sync.bdropy.categoriessubcategories", defaults={"auth_required"=false}, methods={"GET"})
     * @Route("/api/v{version}/slox_product_sync/bdropy/categoriessubcategories", name="api.slox_product_sync_old.bdropy.categoriessubcategories", defaults={"auth_required"=false}, methods={"GET"})
     */
    public function bdropy_categoriessubcategories(Request $request): JsonResponse
    {
        try {
            return new JsonResponse([
                'success' => true,
