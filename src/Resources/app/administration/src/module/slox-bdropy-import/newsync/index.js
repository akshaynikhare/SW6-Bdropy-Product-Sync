...
Component.register('slox-bdropy-import-newsync', {
    template,
    ...
    methods: {
        async onSubmitStatus() {
            let response = await this.AdminControlService.newsyncStatus();
            if (response.log) {
            ...
            let response1 = await this.AdminControlService.newsync();
        ...
        async onSubmit() {
            ...
            let response = await this.AdminControlService.newsync();
            location.reload();
        },
    },
